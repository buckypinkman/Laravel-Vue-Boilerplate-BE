...
use App\Http\Requests\SavingAccountCreateRequest;
...
class SavingAccountController extends BaseController
{
    protected $model;
     ...
     */
    public function store(SavingAccountCreateRequest $request)
    {
        DB::beginTransaction();
        try {
